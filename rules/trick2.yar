...
rule sig_4becc0d518a97cc31427cd08348958cda4e00487c7ec0ac38fdcd53bbe36b5cc {
   ...
   strings:
      ...
      $s5 = "Injecting process pid = %ld" fullword ascii /* score: '29.00'*/
      ...
      $s9 = "Injection failure process pid = %ld" fullword ascii /* score: '28.00'*/
      $s10 = "[HTTP::ExecuteMethod] Content type = %s" fullword ascii /* score: '28.00'*/
...
rule ef6603a7ef46177ecba194148f72d396d0ddae47e3d6e86cf43085e34b3a64d4 {
   ...
   strings:
      ...
      $s14 = "\\Google\\Chrome\\User Data\\Default\\Login Data.bak" fullword ascii /* score: '19.00'*/
      $s15 = "\\\\.\\pipe\\pidplacesomepipe" fullword ascii /* score: '19.00'*/
      $s16 = "c:\\config.bin" fullword ascii /* score: '19.00'*/
      $s17 = "STATIC INJECT OVERRIDE" fullword ascii /* score: '18.00'*/
...
rule sig_6a75c212b49093517e6c29dcb2644df57a931194cf5cbd58e39e649c4a2b84ba {
   ...
   strings:
      ...
      $s13 = "bInw/r^." fullword ascii /* score: '7.00'*/
...
rule e2e034dfa6cc9e5dae4121a0b3fa6d56 {
   ...
   strings:
      ...
      $s9 = "407P7T7X7@:D:H:L:P:T:X:\\:`:d:h:l:p:t:x:|:" fullword ascii /* score: '7.00'*/
      $s10 = "u2Q]r:\"" fullword ascii /* score: '7.00'*/
      ...
      $s15 = "bynsswovjv0" fullword ascii /* score: '5.00'*/
