...
rule sig_4becc0d518a97cc31427cd08348958cda4e00487c7ec0ac38fdcd53bbe36b5cc {
   ...
   strings:
      ...
      $s15 = "Injected process pid = %ld" fullword ascii /* score: '25.00'*/
      ...
      $s18 = "crashreporter.exe" fullword ascii /* score: '25.00'*/
      $s19 = "chrome.dll" fullword ascii /* score: '23.00'*/
      $s20 = "splice.dll" fullword ascii /* score: '23.00'*/
   condition:
...
rule ef6603a7ef46177ecba194148f72d396d0ddae47e3d6e86cf43085e34b3a64d4 {
   ...
   strings:
      ...
      $s11 = "Skip DPOST on %s - disabled (%ld)" fullword ascii /* score: '20.00'*/
      ...
      $s16 = "\\\\.\\pipe\\pidplacesomepipe" fullword ascii /* score: '19.00'*/
      ...
      $s20 = "STATIC INJECT OVERRIDE" fullword ascii /* score: '18.00'*/
   condition:
      uint16(0) == 0x5a4d and filesize < 3000KB and
...
rule e2e034dfa6cc9e5dae4121a0b3fa6d56 {
   ...
   strings:
      ...
      $s19 = "Y+ [9!" fullword ascii /* score: '5.00'*/
...
rule ec2a22d92dd78e37a6705c8116251fabdae2afecb358b32be32da58008115f77 {
   ...
   strings:
      ...
      $s12 = ".?AVCDrawTextCommand@@" fullword ascii /* score: '12.00'*/
      $s13 = ".?AV?$DlgEffectThreeSlider@VFCEffectSoftPortrait@@@@" fullword ascii /* score: '12.00'*/
      $s14 = ".?AVCResizeImageCommand@@" fullword ascii /* score: '12.00'*/
