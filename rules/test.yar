...
rule sig_4becc0d518a97cc31427cd08348958cda4e00487c7ec0ac38fdcd53bbe36b5cc {
   ...
   strings:
      ...
      $s4 = "[INJECT] inject_via_remotethread_wow64: VirtualAlloc pExecuteX64 failed" fullword ascii /* score: '29.00'*/
      $s5 = "[INJECT] inject_via_remotethread_wow64: pExecuteX64( pX64function, ctx ) failed" fullword ascii /* score: '29.00'*/
      $s6 = "Injecting process pid = %ld" fullword ascii /* score: '29.00'*/
      ...
      $s11 = "[INJECT] inject_via_remotethread_wow64: GetVersionEx failed" fullword ascii /* score: '28.00'*/
      ...
      $s17 = "runtimebroker.exe" fullword ascii /* score: '25.00'*/
      $s18 = "Injected process pid = %ld" fullword ascii /* score: '25.00'*/
      $s19 = "chrome.dll" fullword ascii /* score: '23.00'*/
...
rule ef6603a7ef46177ecba194148f72d396d0ddae47e3d6e86cf43085e34b3a64d4 {
   ...
   strings:
      ...
      $s10 = "DPOST failed - no servers responding. DISABLED for 10 minutes!" fullword ascii /* score: '20.00'*/
      $s11 = "core-dll.dll" fullword ascii /* score: '20.00'*/
      $s12 = "Skip DPOST on %s - disabled (%ld)" fullword ascii /* score: '20.00'*/
      $s13 = ";UWININET.DLL" fullword ascii /* score: '20.00'*/
      $s14 = "\\\\.\\pipe\\pidplacesomepipe" fullword ascii /* score: '19.00'*/
      $s15 = "\\Google\\Chrome\\User Data\\Default\\Login Data.bak" fullword ascii /* score: '19.00'*/
      $s16 = "c:\\config.bin" fullword ascii /* score: '19.00'*/
      $s17 = "Failed to read rules - exit" fullword ascii /* score: '18.00'*/
      $s18 = "(): PeProcessRelocs error" fullword ascii /* score: '18.00'*/
      $s19 = "(): PeProcessImport error" fullword ascii /* score: '18.00'*/
...
rule sig_6a75c212b49093517e6c29dcb2644df57a931194cf5cbd58e39e649c4a2b84ba {
   ...
   strings:
      ...
      $s14 = "\\.\"I+v" fullword ascii /* score: '7.00'*/
...
rule e2e034dfa6cc9e5dae4121a0b3fa6d56 {
   ...
   strings:
      ...
      $s6 = "lfjurbcrjnbynsswovjvtnjbywcifjclfjurbcrjnbynsswovjvtnjbywcifjclfjurbcrjnbynsswovjvtnjbywcifjclfjurbcrjnbynsswovjvtnjbywcifjclfju" ascii /* score: '8.00'*/
      $s7 = "lfjurbcrjnbynsswovjvtnjbywcifjc" fullword ascii /* score: '8.00'*/
      $s8 = "vjvtnjbywcifjclfjurbcrjnbynsswovjvtnjbywcifjclfjurbcrjnbynsswovjvtnjbywcifjclfjurbcrjnbynsswovjvtnjbywcifjclfjurbcrjnbynsswovjvt" ascii /* score: '8.00'*/
      ...
      $s15 = "vtujfy" fullword ascii /* score: '5.00'*/
      $s16 = "k /kTv" fullword ascii /* score: '5.00'*/
      $s17 = "Y+ [9!" fullword ascii /* score: '5.00'*/
      $s18 = "bynsswovjv0" fullword ascii /* score: '5.00'*/
      $s19 = "crhnny" fullword ascii /* score: '5.00'*/
...
rule ec2a22d92dd78e37a6705c8116251fabdae2afecb358b32be32da58008115f77 {
   ...
   strings:
      ...
      $s8 = ".?AVCProcessTask@DlgEffectBase@@" fullword ascii /* score: '15.00'*/
      ...
      $s11 = ".?AVFCEffectSoftPortrait@@" fullword ascii /* score: '12.00'*/
