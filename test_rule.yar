...
rule sig_4becc0d518a97cc31427cd08348958cda4e00487c7ec0ac38fdcd53bbe36b5cc {
   meta:
      description = "Trickbot - file 4becc0d518a97cc31427cd08348958cda4e00487c7ec0ac38fdcd53bbe36b5cc"
      author = "yarGen Rule Generator"
      reference = "https://github.com/Neo23x0/yarGen"
      date = "2026-05-15"
   ...
   strings:
      ...
      $s5 = "[INJECT] inject_via_remotethread_wow64: VirtualAlloc pExecuteX64 failed" fullword ascii /* score: '29.00'*/
      $s6 = "[INJECT] inject_via_remotethread_wow64: pExecuteX64( pX64function, ctx ) failed" fullword ascii /* score: '29.00'*/
      $s7 = "\\System32\\KERNEL32.DLL" fullword wide /* score: '29.00'*/
      $s8 = "\\System32\\kernelbase.dll" fullword wide /* score: '29.00'*/
      $s9 = "[HTTP::ExecuteMethod] Content type = %s" fullword ascii /* score: '28.00'*/
      $s10 = "[INJECT] inject_via_remotethread_wow64: GetVersionEx failed" fullword ascii /* score: '28.00'*/
      $s11 = "Injection failure process pid = %ld" fullword ascii /* score: '28.00'*/
      $s12 = "Failed to read Edge passwords from loader module" fullword ascii /* score: '27.00'*/
      $s13 = "[INJECT] inject_via_remotethread_wow64: pExecuteX64=0x%08p, pX64function=0x%08p, ctx=0x%08p" fullword ascii /* score: '26.00'*/
      $s14 = "Failed to inject the DLL: %ld" fullword ascii /* score: '26.00'*/
      $s15 = "runtimebroker.exe" fullword ascii /* score: '25.00'*/
      $s16 = "DLL and target process must be same architecture" fullword ascii /* score: '25.00'*/
      $s17 = "crashreporter.exe" fullword ascii /* score: '25.00'*/
      $s18 = "Injected process pid = %ld" fullword ascii /* score: '25.00'*/
      $s19 = "splice.dll" fullword ascii /* score: '23.00'*/
      $s20 = "[INJECT] inject_via_remotethread_wow64: VirtualAlloc pX64function failed" fullword ascii /* score: '23.00'*/
   condition:
...
rule ef6603a7ef46177ecba194148f72d396d0ddae47e3d6e86cf43085e34b3a64d4 {
   meta:
      description = "Trickbot - file ef6603a7ef46177ecba194148f72d396d0ddae47e3d6e86cf43085e34b3a64d4"
      author = "yarGen Rule Generator"
      reference = "https://github.com/Neo23x0/yarGen"
      date = "2026-05-15"
   ...
   strings:
      ...
      $s8 = "Failed to read DPost config- exit" fullword ascii /* score: '22.00'*/
      $s9 = "updater.exe" fullword ascii /* score: '22.00'*/
      $s10 = "Skip DPOST on %s - disabled (%ld)" fullword ascii /* score: '20.00'*/
      $s11 = "core-dll.dll" fullword ascii /* score: '20.00'*/
      $s12 = ";UWININET.DLL" fullword ascii /* score: '20.00'*/
      $s13 = "DPOST failed - no servers responding. DISABLED for 10 minutes!" fullword ascii /* score: '20.00'*/
      $s14 = "\\\\.\\pipe\\pidplacesomepipe" fullword ascii /* score: '19.00'*/
      $s15 = "c:\\config.bin" fullword ascii /* score: '19.00'*/
      $s16 = "\\Google\\Chrome\\User Data\\Default\\Login Data.bak" fullword ascii /* score: '19.00'*/
      $s17 = "(): PeProcessImport error" fullword ascii /* score: '18.00'*/
      $s18 = "STATIC INJECT OVERRIDE" fullword ascii /* score: '18.00'*/
      $s19 = "Failed to read ID - exit" fullword ascii /* score: '18.00'*/
      $s20 = "Failed to read rules - exit" fullword ascii /* score: '18.00'*/
   condition:
      uint16(0) == 0x5a4d and filesize < 3000KB and
...
rule sig_6a75c212b49093517e6c29dcb2644df57a931194cf5cbd58e39e649c4a2b84ba {
   meta:
      description = "Trickbot - file 6a75c212b49093517e6c29dcb2644df57a931194cf5cbd58e39e649c4a2b84ba"
      author = "yarGen Rule Generator"
      reference = "https://github.com/Neo23x0/yarGen"
      date = "2026-05-15"
   ...
   strings:
      ...
      $s6 = "<moduleconfig><nohead>yes</nohead><needinfo name=\"id\"/><needinfo name=\"ip\"/><autoconf><conf ctl=\"winj\" file=\"winj\" perio" ascii /* score: '12.00'*/
      $s7 = "><conf ctl=\"dpost\" file=\"dpost\" period=\"60\"/></autoconf></moduleconfig>" fullword ascii /* score: '12.00'*/
      ...
      $s11 = "fghijklm" fullword ascii /* score: '8.00'*/
      $s12 = "nopqrstu" fullword ascii /* score: '8.00'*/
      $s13 = "\\.\"I+v" fullword ascii /* score: '7.00'*/
      $s14 = "4Y:\\a4AP" fullword ascii /* score: '7.00'*/
      $s15 = "bInw/r^." fullword ascii /* score: '7.00'*/
      $s16 = "$\"%d,!g" fullword ascii /* score: '6.50'*/
      $s17 = "LMNOPQRSJT" fullword ascii /* score: '6.50'*/
      $s18 = " Base Class Descriptor at (" fullword ascii /* score: '6.00'*/
      $s19 = " Class Hierarchy Descriptor'" fullword ascii /* score: '6.00'*/
...
rule e2e034dfa6cc9e5dae4121a0b3fa6d56 {
   meta:
      description = "Trickbot - file e2e034dfa6cc9e5dae4121a0b3fa6d56"
      author = "yarGen Rule Generator"
      reference = "https://github.com/Neo23x0/yarGen"
      date = "2026-05-15"
   ...
   strings:
      ...
      $s6 = "lfjurbcrjnbynsswovjvtnjbywcifjc" fullword ascii /* score: '8.00'*/
      $s7 = "vjvtnjbywcifjclfjurbcrjnbynsswovjvtnjbywcifjclfjurbcrjnbynsswovjvtnjbywcifjclfjurbcrjnbynsswovjvtnjbywcifjclfjurbcrjnbynsswovjvt" ascii /* score: '8.00'*/
      $s8 = "lfjurbcrjnbynsswovjvtnjbywcifjclfjurbcrjnbynsswovjvtnjbywcifjclfjurbcrjnbynsswovjvtnjbywcifjclfjurbcrjnbynsswovjvtnjbywcifjclfju" ascii /* score: '8.00'*/
      ...
      $s15 = "crhnny" fullword ascii /* score: '5.00'*/
      $s16 = "bynsswovjv0" fullword ascii /* score: '5.00'*/
      $s17 = "vtujfy" fullword ascii /* score: '5.00'*/
      $s18 = "Y+ [9!" fullword ascii /* score: '5.00'*/
...
rule ec2a22d92dd78e37a6705c8116251fabdae2afecb358b32be32da58008115f77 {
   meta:
      description = "Trickbot - file ec2a22d92dd78e37a6705c8116251fabdae2afecb358b32be32da58008115f77"
      author = "yarGen Rule Generator"
      reference = "https://github.com/Neo23x0/yarGen"
      date = "2026-05-15"
   ...
   strings:
      ...
      $s11 = ".?AVCDrawTextCommand@@" fullword ascii /* score: '12.00'*/
      $s12 = ".?AVCResizeImageCommand@@" fullword ascii /* score: '12.00'*/
      $s13 = ".?AVFCEffectSoftPortrait@@" fullword ascii /* score: '12.00'*/
      ...
      $s16 = "Paint.NET v2.6%" fullword ascii /* score: '10.00'*/
      $s17 = "Paint.NET v2.64" fullword ascii /* score: '10.00'*/
...
rule _4becc0d518a97cc31427cd08348958cda4e00487c7ec0ac38fdcd53bbe36b5cc_ef6603a7ef46177ecba194148f72d396d0ddae47e3d6e86cf43085e34b_0 {
   meta:
      description = "Trickbot - from files 4becc0d518a97cc31427cd08348958cda4e00487c7ec0ac38fdcd53bbe36b5cc, ef6603a7ef46177ecba194148f72d396d0ddae47e3d6e86cf43085e34b3a64d4"
      author = "yarGen Rule Generator"
      reference = "https://github.com/Neo23x0/yarGen"
      date = "2026-05-15"
      hash1 = "4becc0d518a97cc31427cd08348958cda4e00487c7ec0ac38fdcd53bbe36b5cc"
